...
export const CHUNKING_STRATEGY_NAMES = ['fixed-size', 'recursive', 'markdown-aware', 'csv-row'] as const;
export const KNOWLEDGE_SOURCE_TYPES = ['document', 'website', 'faq', 'policy', 'manual', 'other'] as const;
