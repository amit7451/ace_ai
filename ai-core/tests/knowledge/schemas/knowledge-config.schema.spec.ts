import { knowledgeProcessingConfigSchema, chunkingOptionsSchema } from '../../../src/knowledge/schemas/knowledge-config.schema';
...
describe('chunkingOptionsSchema', () => {
  ...
  it('accepts chunkOverlap smaller than maxChunkSize', () => {
    expect(() => chunkingOptionsSchema.parse({ maxChunkSize: 100, chunkOverlap: 50 })).not.toThrow();
  });
});
