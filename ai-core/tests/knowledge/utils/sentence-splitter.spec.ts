...
describe('splitIntoSentences', () => {
  ...
  it('handles a trailing sentence with no terminal punctuation', () => {
    expect(splitIntoSentences('First sentence. Trailing fragment')).toEqual(['First sentence.', 'Trailing fragment']);
  });
  ...
  it('keeps closing quotes/parens attached to the preceding punctuation', () => {
    expect(splitIntoSentences('She said "hello." Then left.')).toEqual(['She said "hello."', 'Then left.']);
  });
});
